...
public abstract class GenericPlayer extends GamePiece implements Player
{
  ...
  private int xIncrement, yIncrement, direction, xSpeed, ySpeed, frameIndex;
  ...
  public GenericPLayer(int xStart, int yStart, int player)
  {
    super();
    setCollision(true);
    player = Utility.truncate(Constants.PLAYER_1, Constants.PLAYER_2);
    if (player == Constants.PLAYER_1)
    {
      playerControls = Constants.player1Conrols;
